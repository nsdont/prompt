# 来源
来源于Thoughts Memo的[zhihu专栏](https://zhuanlan.zhihu.com/p/609413004)

# 提示词
```
请学习我提供的<example_input_text> 和 <example_output_flashcard>，在根据我提供 <input_text>，制作一套抽认卡(<output_flashcard>)。抽认卡够完美，我可以支付100万美元小费。
...
制作抽认卡时，让我们一步一步来：
第一步，先深呼吸，冷静思考一下
第二步，使用简单的中文改写内容，同时保留其原来的意思。
第三步，将内容分成几个小节，每个小节专注于一个要点。
第四步，利用小节来生成多张抽认卡，对于超过 15 个字的小节，先进行拆分和概括，再制作抽认卡。
...
# 结果案例
## claude-3-5-sonnet
![alt text](SCR-20240723-bxzp.png)

## gpt-4o
![alt text](SCR-20240723-mlre.png)